...
path = (path +'/Variable_metadata_path.txt')

with open(path,'r') as f:
    for line in f:
        variable_metadata = line.rstrip().strip()
...
folder_to_databases = '###database_location###'
Variable_Metadata_path = variable_metadata
output_folder = "!@#$%^&82&^%$#@!"
ppm = !@#$%^&83&^%$#@!
limit_output_query = !@#$%^&84&^%$#@!
