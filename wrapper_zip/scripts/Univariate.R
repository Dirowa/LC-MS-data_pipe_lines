...
test <- c("ttest", "limma", "wilcoxon", "anova", "kruskal", "pearson", "spearman","limma2ways", "limma2waysInter", "anova2ways", "anova2waysInter")[!@#$%^&5&^%$#@!]


variables_of_interest <- "!@#$%^&6&^%$#@!"
correcting_data_set_according_variable <- "!@#$%^&7&^%$#@!"
factor_of_interest <- '!@#$%^&8&^%$#@!'
second_factor_of_interest <- '!@#$%^&9&^%$#@!'

P_value_treshhold <- !@#$%^&10&^%$#@!
max_features_output <- "!@#$%^&11&^%$#@!"
graph_title <- '!@#$%^&12&^%$#@!'
pre_fix_of_report <- "!@#$%^&13&^%$#@!"
...
######## heatmap ###########
cluster_groups_of_samples<- !@#$%^&19&^%$#@!
cluster_groups_of_features<- !@#$%^&20&^%$#@!

heat_map_statistics <- c("pearson", "kendall", "spearman")[!@#$%^&21&^%$#@!]
