...
################
  ...
  # Variables   #
  ###############
scripts_locaion <- '####scripts_location####'
...
###### Batch_correction #####
  ...
  Best_peakpicked_based_on <- c("mean_var_QC_log10","Ratio_VAR_total_QC_log")[!@#$%^&51&^%$#@!]
...
test <- c("ttest", "limma", "wilcoxon", "anova", "kruskal", "pearson", "spearman","limma2ways", "limma2waysInter", "anova2ways", "anova2waysInter")[!@#$%^&59&^%$#@!]


variables_of_interest <- "!@#$%^&60&^%$#@!"
correcting_data_set_according_variable <- "!@#$%^&61&^%$#@!"
factor_of_interest <- '!@#$%^&62&^%$#@!'
second_factor_of_interest <- '!@#$%^&63&^%$#@!'

P_value_treshhold <- !@#$%^&64&^%$#@!
max_features_output <- "!@#$%^&65&^%$#@!"
graph_title <- '!@#$%^&66&^%$#@!'
pre_fix_of_report <- "!@#$%^&67&^%$#@!"
...
######## heatmap ###########
cluster_groups_of_samples<- !@#$%^&71&^%$#@!
cluster_groups_of_features<- !@#$%^&72&^%$#@!

heat_map_statistics <- c("pearson", "kendall", "spearman")[!@#$%^&73&^%$#@!]
...
filter_significant_hits = !@#$%^&75&^%$#@!
filter_QC_SAMPLE_RATIO = !@#$%^&76&^%$#@!
FILTER_blank_SAMPLE_RATIO = !@#$%^&77&^%$#@!


minium_QC_sample_cutoff_ratio <- !@#$%^&78&^%$#@!
maximum_QC_sample_cutoff_ratio <- !@#$%^&79&^%$#@!

minium_QC_blank_cutoff_ratio <- !@#$%^&80&^%$#@!
maximum_QC_blank_cutoff_ratio <- !@#$%^&81&^%$#@!
...
print(scripts_locaion)
scripts_locaion <- paste0(scripts_locaion,'/Variable_metadata_path.txt')
print('writing over neccasary files for annoation')
print(scripts_locaion)
fileConn<-file(scripts_locaion)
writeLines(paste0(outputfolder,tmp,'_filterd_variable_metadata.tsv'), fileConn)
close(fileConn)
