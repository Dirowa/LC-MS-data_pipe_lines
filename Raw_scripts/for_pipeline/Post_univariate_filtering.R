...
folder <- "F:/avans/stage MM/bets_parameter_test/_XCMS_IPO/batch_correction/pre_univariate_filterd/ttest_gender"
data_matrix <- "XCMS_IPO_batchcorrected_pre_univariate_filterd_matrix.tsv_ttest_gender.tsv"
sample_metadata <- "XCMS_IPO_batchcorrected_pre_univariate_filterd_samplemetadata.tsv_ttest_gender.tsv"
variable_metadata <-"XCMS_IPO_batchcorrected_pre_univariate_filterd_variable_metadata.tsv_ttest_gender.tsv"
variable_metadata 

outputfolder_name <- "filterd1"
