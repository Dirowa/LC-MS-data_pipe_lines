...
numerical_factor_of_interest <- 'age'
...
rownames_to_remove <- rownames(sampleMetadata %>% filter(sampleType == QC_names| sampleType == blank_names))
...
png(filename = paste0(output_folder,'smallplot',result,'overview.png'),
